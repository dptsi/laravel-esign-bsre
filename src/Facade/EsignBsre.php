 ...
 * @method static mixed signVisibleWithSpesimenWithTagKoordinate(\Illuminate\Http\File|\Illuminate\Http\UploadedFile $file, string $nik, string $passphrase, \Illuminate\Http\File|\Illuminate\Http\UploadedFile $image_ttd, string $tag_koordinate, int $width, int $height)
 * @method static mixed signVisibleWithQrCodeWithTagKoordinate(\Illuminate\Http\File|\Illuminate\Http\UploadedFile $file, string $nik, string $passphrase, string $link_qrcode, string $tag_koordinate, int $width, int $height)
 * @method static mixed verifyDocument(\Illuminate\Http\File|\Illuminate\Http\UploadedFile $file)
 */
